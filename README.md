...
The draft in-memory workspace access contract and its integration limits are
recorded in [`docs/hosted-workspace-state.md`](docs/hosted-workspace-state.md).
It does not provide hosted persistence, authentication, or a running service.
